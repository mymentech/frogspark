        ...
        <div class="row">
            <div class="col-md-6">
                <div class="page-thumbanil">
                    ...
                    <p class="text-center m-5"><a href="//vitamyne.frogspark.agency/order/" class="btn btn-secondary make-my-btn"><img src="<?php echo get_template_directory_uri(); ?>/img/path-icon.png">Make my NOURISH<span class="txt-rotate">E</span>D</a></p>
                </div>
            </div>
            <div class="col-md-6">
